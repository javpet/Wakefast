...
const runScripts = function() {
  if (mq.matches) {
    ...
    const changeScroll = function() {
      ...
      // Updating the page scroll with a factor of 0.05
      currentScroll = currentScroll + (aimScroll - currentScroll) * 0.05;

      mainTag.style.top = `-${currentScroll}px`;
      ...
      // requestAnimationFrame will call the function itself
